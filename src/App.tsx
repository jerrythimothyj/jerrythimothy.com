                    ...
                    <ul className="nav navbar-nav hidden-xs">
                        ...
                        <li className="hidden-xs"> 
                            ...
                            <div className="fullscreen-search-overlay" id="search-overlay">
                                <a href="#" className="fullscreen-close" id="fullscreen-close-button"><i className="ti-close"></i></a>
                        ...
                        <li><a id="menu-toggle" href="#"><i className="material-icons">apps</i></a></li>
                        <li className="dropdown hidden-sm"><a href="#" className="dropdown-toggle material-ripple" data-toggle="dropdown">Dropdown <b className="caret"></b></a>
                            <ul className="dropdown-menu">
                                <li><a href="#">Dropdown Link 1</a></li>
                                <li><a href="#">Dropdown Link 2</a></li>
                                <li><a href="#">Dropdown Link 3</a></li>
                                <li className="dropdown dropdown-submenu"><a href="#" className="dropdown-toggle" data-toggle="dropdown">Dropdown Link 4</a>
                                    <ul className="dropdown-menu">
                                ...
                                <li className="dropdown dropdown-submenu"><a href="#" className="dropdown-toggle" data-toggle="dropdown">Dropdown Link 5</a>
                                    <ul className="dropdown-menu">
                                        <li><a href="#">Submenu Link 5.1</a></li>
                                        <li><a href="#">Submenu Link 5.2</a></li>
                                        <li><a href="#">Submenu Link 5.3</a></li>
                                        <li className="divider"></li>
                                        <li className="dropdown dropdown-submenu"><a href="#" className="dropdown-toggle" data-toggle="dropdown">Submenu Link 5.4</a>
                                            <ul className="dropdown-menu">
                                                <li><a href="#">Submenu Link 5.4.1</a></li>
                                                <li><a href="#">Submenu Link 5.4.2</a></li>
                                                <li className="divider"></li>
                                                <li className="dropdown dropdown-submenu"><a href="#" className="dropdown-toggle" data-toggle="dropdown">Submenu Link 5.4.3</a>
                                                    <ul className="dropdown-menu">
                                                ...
                                                <li className="dropdown dropdown-submenu"><a href="#" className="dropdown-toggle" data-toggle="dropdown">Submenu Link 5.4.4</a>
                                                    <ul className="dropdown-menu">
                        ...
                        <li className="dropdown mega-dropdown hidden-sm">
                            <a href="#" className="dropdown-toggle material-ripple" data-toggle="dropdown">Megamenu <b className="caret"></b></a>
            ...
            <div className="sidebar" role="navigation">
                <div className="sidebar-nav navbar-collapse">
                    <ul className="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#" className="material-ripple"><i className="material-icons">drafts</i> Mailbox<span className="fa arrow"></span></a>
                            <ul className="nav nav-second-level">
                                <li><a href="mailbox.html">Mailbox<span className="nav-tag green">3</span></a></li>
                                <li><a href="mailDetails.html">Mailbox Details<span className="nav-tag yellow">2</span></a></li>
                                <li><a href="compose.html">Compose<span className="nav-tag red">9</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#" className="material-ripple"><i className="material-icons">business</i> Tables<span className="fa arrow"></span></a>
                            <ul className="nav nav-second-level">
                        ...
                        <li>
                            <a href="#" className="material-ripple"><i className="material-icons">assignment</i> Forms<span className="fa arrow"></span></a>
                            <ul className="nav nav-second-level">
                        ...
                        <li>
                            <a href="#" className="material-ripple"><i className="material-icons">format_color_fill</i> UI Elements<span className="fa arrow"></span></a>
                            <ul className="nav nav-second-level">
                        ...
                        <li>
                            <a href="#" className="material-ripple"><i className="material-icons">map</i> Maps<span className="fa arrow"></span></a>
                            <ul className="nav nav-second-level">
                        ...
                        <li>
                            <a href="#" className="material-ripple"><i className="material-icons">insert_emoticon</i> Icons<span className="fa arrow"></span></a>
                            <ul className="nav nav-second-level">
                        ...
                        <li><a href="widgets.html"><i className="material-icons">widgets</i>Widgets<span className="nav-tag green">new</span></a></li>
                        <li><a href="calender.html"><i className="material-icons">perm_contact_calendar</i>Calendar<span className="nav-tag red">3</span><span className="nav-tag green">5</span><span className="nav-tag yellow">8</span></a></li>
                        <li className="nav-heading "> <span>Extra&nbsp;&nbsp;&nbsp;&nbsp;------</span></li>
                        <li>
                            <a href="#" className="material-ripple"><i className="material-icons">stay_current_portrait</i>App Views<span className="fa arrow"></span></a>
                            <ul className="nav nav-second-level">
                        ...
                        <li>
                            <a href="#" className="material-ripple"><i className="material-icons">devices_other</i>Other pags<span className="fa arrow"></span></a>
                            <ul className="nav nav-second-level">
                        ...
                        <li>
                            <a href="#" className="material-ripple"><i className="material-icons">invert_colors</i> Multi-Level Dropdown<span className="fa arrow"></span></a>
                            <ul className="nav nav-second-level">
                        ...
                        <li><a href="blank.html" className="material-ripple"><i className="material-icons">check_box_outline_blank</i> Blank page</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div className="tab-content">
                        <div role="tabpanel" className="tab-pane fade  in active" id="home">
                            <ul id="styleOptions" title="switch styling">
                                ...
                                <li><a href="javascript: void(0)" data-theme="skin-red-light.min" className="skin-logo"><img src="assets/dist/img/theme-color/5.jpg" alt=""/></a></li>
                                ...
                                <li><a href="javascript: void(0)" data-theme="skin-default-light.min" className="skin-logo"><img src="assets/dist/img/theme-color/3.jpg" alt=""/></a></li>
                            ...
                            <div className="panel panel-bd lobidisable">
                                ...
                                <div className="panel-body">
                                    <div className="monthly_calender">
                                        <div className="monthly" id="m_calendar"></div>
                                    </div>
                                </div>
                                <div className="panel-footer">
                                ...
                                <div className="panel-body">
                                    ...
                                    <div className="chart-legend">
                                        <div className="chart-legend-item">
                                            <div className="chart-legend-color red"></div>
                                            <p>From Google</p>
                                            <p className="percentage">63.259 %</p>
                                        </div>
                                        <div className="chart-legend-item">
                                            <div className="chart-legend-color blue"></div>
                                            <p>Your Website</p>
                                            <p className="percentage">25.321 %</p>
                                        </div>
                                        <div className="chart-legend-item">
                                            <div className="chart-legend-color green"></div>
                                        ...
                                        <table className="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <figure className="user-avatar small">
                                                            <img src="assets/dist/img/avatar.png" className="img-responsive" alt="user-image" />
                                                        </figure>
                                                    </td>
                                                    <td>Naeem Khan</td>
                                                    <td>123 456 7890</td>
                                                    ...
                                                    <td>Noakhali</td>
                                                    <td><a href="#" className="btn btn-success btn-xs">View</a></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <figure className="user-avatar small">
                                                            <img src="assets/dist/img/avatar2.png" className="img-responsive" alt="user-image" />
                                                        </figure>
                                                    </td>
                                                    <td>Tuhin Sarkar</td>
                                                    <td>123 456 7890</td>
                                                    ...
                                                    <td>Lavoir</td>
                                                    <td><a href="#" className="btn btn-success btn-xs active">View</a></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <figure className="user-avatar small">
                                                            <img src="assets/dist/img/avatar6.png" className="img-responsive" alt="user-image" />
                                                        </figure>
                                                    </td>
                                                    <td>Tanjil Ahmed</td>
                                                    <td>456 789 1230</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <figure className="user-avatar small">
                                                            <img src="assets/dist/img/avatar3.png" className="img-responsive" alt="user-image" />
                                                        </figure>
                                                    </td>
                                                    <td>Sourav</td>
                                                    <td>789 123 4560</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <figure className="user-avatar small">
                                                            <img src="assets/dist/img/avatar7.png" className="img-responsive" alt="user-image" />
                                                        </figure>
                                                    </td>
                                                    <td>Jahangir Alam</td>
                                                    <td>(01662) 59083</td>
