const TECH_STACK = [
  {
    name: 'Web Designing & Development - Primary',
    stack: [
      {
      ...
      {
        bullet: 'https://seeklogo.com/images/J/javascript-js-logo-2949701702-seeklogo.com.png',
        color: '#FFBD39',
        name: 'Javascript',
        points: 80,
      },
  ...
  {
    name: 'Web Designing & Development - Secondary',
    stack: [
      {
        bullet: 'https://avatars1.githubusercontent.com/u/28507035?s=200&v=4',
        color: '#E1234E',
        name: 'NestJS',
        points: 60,
      },
  ...
  },
  {
    ...
    stack: [
      ...
      {
        bullet: 'https://raw.githubusercontent.com/webpack/media/master/logo/icon-square-big.png',
        color: '#1C78C0',
        name: 'Webpack',
        points: 60,
      },
  ...
  },
  {
    ...
    stack: [
      ...
      {
        bullet: 'https://seeklogo.com/images/A/autodesk-maya-logo-4B9E2A913A-seeklogo.com.png',
        color: '#015050',
        name: 'MAYA',
        points: 20,
      },
  ...
  },
  {
    ...
    stack: [
      ...
      {
        bullet: 'https://i2.wp.com/qavalidation.com/wp-content/uploads/2017/02/protractor-logo.png',
        color: '#B43031',
...
export const fetchTechStack = () => TECH_STACK
